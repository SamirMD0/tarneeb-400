export default function LoadingBird() {
  return (
    <>
      <style>{`
        .bird-head { animation: bird-bob 1s infinite ease-in; translate: 27px -30px; }
        .bird-bod  { animation: bird-bob 1s infinite ease-in-out; translate: 0px 30px; }
        .bird-legl { animation: bird-lstep 1s infinite ease-in; translate: 30px 155px; }
        .bird-legr { animation: bird-rstep 1s infinite ease-in; animation-delay: 0.45s; translate: 75px 135px; }
        .bird-gnd  {
          translate: -140px 0; rotate: 10deg; z-index: -1;
          filter: blur(0.5px) drop-shadow(1px 3px 5px #000000);
          opacity: 0.25; animation: bird-scroll 5s infinite linear;
        }
        @keyframes bird-bob {
      ...
      <div
        ...
        aria-label="Loading"
        className="relative"
        style={{ scale: '0.75', width: '200px', height: '200px', translate: '10px -20px' }}
      >
        {/* Left leg */}
        <svg className="bird-legl absolute top-0 left-0" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20.69332" height="68.19944" viewBox="0,0,20.69332,68.19944" aria-hidden="true">
        ...
        {/* Right leg */}
        <svg className="bird-legr absolute top-0 left-0" version="1.1" xmlns="http://www.w3.org/2000/svg" width="41.02537" height="64.85502" viewBox="0,0,41.02537,64.85502" aria-hidden="true">
        ...
        {/* Body */}
        <div className="bird-bod absolute top-0 left-0" style={{ zIndex: 3 }}>
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="144.10576" height="144.91623" viewBox="0,0,144.10576,144.91623" aria-hidden="true">
        ...
        {/* Ground */}
        <svg id="bird-gnd" className="bird-gnd absolute top-0 left-0" version="1.1" xmlns="http://www.w3.org/2000/svg" width={475} height={530} viewBox="0,0,163.40011,85.20095" aria-hidden="true">
